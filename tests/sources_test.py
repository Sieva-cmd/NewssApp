...
class SourcesTest(unittest.TestCase):
    ...
    def Setup(self):
        ...
        '''
        self.new_source = News_source('ABC News','Your trusted source for breaking news, analysis, exclusive interviews, headlines, and videos at ABCNews.com.','https://abcnews.go.com')
